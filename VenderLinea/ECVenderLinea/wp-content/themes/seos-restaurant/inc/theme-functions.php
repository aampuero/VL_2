...
function seos_restaurant_back_to_top() {
    ...
    add_action( 'wp_head', 'seos_restaurant_back_to_top_style' );
    function seos_restaurant_back_to_top_style() {
    ...
    add_action( 'wp_footer', 'seos_restaurant_to_top_script' );
    function seos_restaurant_to_top_script() { ?>
